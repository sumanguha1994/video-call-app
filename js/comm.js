...
if(location.protocol === 'http:'){
    //https://webbies.co/stage/stage11/video-call-app:80
    wsChat = new WebSocket("ws://localhost:80/video-call-app/ws");
}else{
    wsChat = new WebSocket("wss://localhost:80/video-call-app/ws");
}
...
window.addEventListener('load', function(){
    ...
    xhr.open("GET", appRoot+"ws/bin/"+"server.php", true);
    xhr.send();
